$(document).ready(function () {
  ...
  // 🎯 STACKADAPT PIXEL
  (function initStackAdapt() {
    if (window.saq) {
      console.log('ℹ️ StackAdapt already initialized');
      return;
    }
    ...
    saq('ts', 'UKzXu-6RUx4HTz0rlRpBwQ');
    console.log('✅ StackAdapt pixel initialized');
  })();
  ...
  // Expose finalUTMs globally for other scripts (e.g., numero.js)
  window.finalUTMs = finalUTMs;
...
function addPetitionLanguageToWebflow() {
  ...
  (function() {
    ...
    const observer = new MutationObserver(function(mutations) {
      ...
      if (utmField && !utmField.value && finalUTMs && finalUTMs.utm_source) {
